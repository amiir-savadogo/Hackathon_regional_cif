  ...
  template: `
    <div class="flex h-screen bg-gray-100 font-sans overflow-hidden relative">
      ...
      <aside 
        ...
        class="fixed md:static inset-y-0 left-0 z-40 w-64 bg-slate-800 text-white flex flex-col flex-shrink-0 transition-all duration-300 ease-in-out md:translate-x-0 shadow-xl md:shadow-none">
        
        <!-- Logo / Titre (Bureau) avec bouton collapse -->
        <div class="hidden md:flex py-5 border-b border-slate-700 items-center justify-between transition-all duration-300"
          [ngClass]="isDesktopCollapsed ? 'px-4' : 'px-5'">
          <div class="flex items-center space-x-3 overflow-hidden">
            <div class="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md shadow-blue-500/20">
      ...
      <div class="flex-1 flex flex-col overflow-hidden w-full pt-14 md:pt-0">
        ...
        <header class="hidden md:flex h-16 bg-white border-b border-gray-200 items-center justify-between px-6 z-10 flex-shrink-0">
          <div class="flex items-center space-x-3">
            ...
            <button (click)="toggleDesktopSidebar()" 
              class="p-2 rounded-lg text-gray-500 hover:text-blue-700 hover:bg-blue-50 transition-colors focus:outline-none" 
            ...
            <span class="px-2.5 py-1 text-xs font-semibold rounded-full bg-blue-50 text-blue-700 border border-blue-100 flex items-center gap-1.5">
